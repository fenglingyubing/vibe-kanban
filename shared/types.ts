...
export type NotificationConfig = { sound_enabled: boolean, push_enabled: boolean, sound_file: SoundFile, email_enabled: boolean, email_to: string | null, email_smtp_host: string | null, email_smtp_port: number, email_smtp_username: string | null, email_smtp_password: string | null, email_from: string | null, email_smtp_use_starttls: boolean, };
